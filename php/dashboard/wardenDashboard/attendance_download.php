...
$query = "SELECT id, name, admission_no, branch, semester, morning, night, date, matron, hs FROM attendance WHERE date = '$currentDate'";
$result = mysqli_query($conn, $query);

// Add table to PDF for attendance
$html = '<h2 style="text-align: center;">Attendance for ' . $currentDate . '</h2><table border="1">';
$html .= '<thead>
            <tr>
