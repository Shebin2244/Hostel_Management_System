                ...
                <div class="report-body">
                    <table>
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM attendance WHERE date BETWEEN '$firstDayOfMonth' AND '$lastDayOfMonth' AND hs = 1 AND matron = 1 AND admission_no = '$admissionNo'";
                            $result = mysqli_query($conn, $query);
                            
                            if (isset($_GET['searchDate'])) {
                                $searchDate = $_GET['searchDate'];
                                $query = "SELECT * FROM attendance WHERE date = '$searchDate' AND hs = 1 AND matron = 1 AND admission_no = '$admissionNo'";
                                $result = mysqli_query($conn, $query);
