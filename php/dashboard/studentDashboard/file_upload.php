...
<div class="complaint-section">
    <!-- File Upload Form -->
    <h3>Upload Documents (.pdf, .doc, .docx)</h3>
<form id="fileUploadForm" action="process_file_upload.php" method="post" enctype="multipart/form-data">
    <!-- Add input fields for different document types -->
    <label for="incomeCertificate">Income Certificate:</label>
    <input type="file" name="incomeCertificate" class="complaint-input" accept=".pdf, .doc, .docx" required >

    <label for="communityCertificate">Community Certificate:</label>
    <input type="file" name="communityCertificate" class="complaint-input" accept=".pdf, .doc, .docx">

    <label for="aadharCard">Aadhar Card:</label>
    <input type="file" name="aadharCard" class="complaint-input" accept=".pdf, .jpg, .jpeg, .png" required>

    <label for="rationCard">Ration Card:</label>
    <input type="file" name="rationCard" class="complaint-input" accept=".pdf, .jpg, .jpeg, .png" required>
