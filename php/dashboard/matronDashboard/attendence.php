                ...
                <div class="report-body">                <button class="view" id="confirmAllButton"><a href="attendance_download.php">Download</a></button>
                    ...
                    <table>
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM attendance WHERE date = '$searchDate' AND hs = 1";
                ...
                <script>
                    ...
                    markConfirmationButtons.forEach(button => {
                        button.addEventListener('click', function () {
                            ...
                            xhr.open('POST', 'update_matron.php'); // Create a PHP script to handle the update
                    ...
                    confirmAllButton.addEventListener('click', function () {
                        ...
                        const xhr = new XMLHttpRequest();
                        xhr.open('POST', 'update_all_matron.php'); // Create a PHP script to handle the update for all
                        xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                        xhr.onload = function () {
                            if (xhr.status === 200) {
                                // Reload the page to reflect the updated data
